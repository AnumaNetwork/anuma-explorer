...
function App() {
    ...
    const updatePrice = () => {
        fetch(`https://api.anuma.network/info/market-data`, {
            ...
            <PriceContext.Provider value={{price, marketData}}>
                <BlueScoreContext.Provider value={{blueScore}}>
                            ...
                            <Container id="navbar-container" fluid>
                                    ...
                                    <Navbar.Brand>
                                        <Link to="/">
                                            <div className="navbar-brand">
                                                <img className="shake" src="/a-icon-glow.png"
                                                     style={{"marginRight": ".5rem", width: "4rem", height: "4rem"}}/>
                                                <div className="navbar-brand-text text-start">ANUMA<br/>EXPLORER</div>
                                            </div>
                                        </Link>
                                    </Navbar.Brand>
                                </div>
                                ...
                                <Navbar.Collapse id="responsive-navbar-nav">
                                    ...
                                    <div className='ms-auto navbar-price'>${price} <span
                                        className="text-light">/ ANUM</span></div>
                                </Navbar.Collapse>
                            </Container>
                        </Navbar>
                                    ...
                                    <Form onSubmit={search} className="">
                                        <InputGroup className="mt-4 mb-4 search-box-group">
                                            <Form.Control className="d-inline-block bg-light text-dark shadow-none"
                                                          ...
                                                          placeholder="Search for anuma:address or block"/>
                    ...
                    <OverlayTrigger placement="left" overlay={<Tooltip id="github">Source code</Tooltip>}>
                      <a className="blockinfo-link" href="https://github.com/AnumaNetwork/anuma-explorer"
                    ...
                    <OverlayTrigger placement="right" overlay={<Tooltip id="donate">Donation address</Tooltip>}>
                      <Link className="blockinfo-link ms-3"
                            to="/addresses/anuma:qqkqkzjvr7zwxxmjxjkmxxdwju9kjs6e9u82uh59z07vgaks6gg62v8707g73"><BiDonateHeart
                          size="1.3rem"/></Link>
                    </OverlayTrigger>
                    <OverlayTrigger placement="right" overlay={<Tooltip id="github">REST-API server</Tooltip>}>
                      <a className="blockinfo-link ms-3" href="https://api.anuma.network/" target="_blank"><SiFastapi
                          size="1.3rem"/></a>
                    </OverlayTrigger>
                  </span>
                  ...
                  <span className="ms-2">
                    ...
                    <OverlayTrigger placement="right" overlay={<Tooltip id="github">REST-API server</Tooltip>}>
                      <a className="blockinfo-link ms-2" href="https://api.anuma.network/" target="_blank"><SiFastapi
                          size="1.1rem"/></a>
                    </OverlayTrigger>
                  </span>
                                </Col>
