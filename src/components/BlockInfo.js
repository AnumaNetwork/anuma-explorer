                            ...
                            <Container className="blockinfo-table mx-0" fluid>
                                <Row className="blockinfo-row">
                                    ...
                                    <Col className="blockinfo-value-mono" lg={10}>{blockInfo.verboseData.hash}
                                        ...
                                        <OverlayTrigger
                                            overlay={<Tooltip id="tooltip-kgi">Open in Anuma Graph Inspector</Tooltip>}>
                                            <span>
                                        ...
                                        <Row className="utxo-border py-3">
                                                            ...
                                                            <Col xs={12} sm={8} md={9} lg={9} xl={8} xxl={7}
                                                                ...
                                                                <CopyButton
                                                                    text={txOutput.verboseData.scriptPublicKeyAddress}/>
                                                                       ...
                                                                       md={3}>+{numberWithCommas(txOutput.amount / 100000000)}&nbsp;ANUM</Col>
                                                        </Row>)}
                                                    </Container>
                                                </Col>
                                            </Col>
                                            <Col sm={5} md={4}>
                                                ...
                                                <div className="utxo-value d-flex flex-row">
                                                    <div
                                                        className="utxo-amount">{(numberWithCommas(tx.outputs.reduce((a, b) => (a || 0) + parseInt(b.amount), 0) / 100000000))} ANUM
                                                    </div>
                                                </div>
                                            </Col>
                                            <Col sm={3} md={2}>
